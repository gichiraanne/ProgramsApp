...
describe('ActivityEditComponent', () => {
  ...
  @Component({
    ...
    template: `<app-activity-edit [activityData]="activityData"></app-activity-edit>`
  })
  class ActivitiesComponent {
    ...
    setInput(newInput: object) {
      this.activityData = newInput;
    }
  }

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ActivityEditComponent, ActivitiesComponent],
